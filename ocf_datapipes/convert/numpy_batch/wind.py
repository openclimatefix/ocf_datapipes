    ...
    def __iter__(self) -> NumpyBatch:
        ...
        for xr_data in self.source_datapipe:
            ...
            example: NumpyBatch = {
                ...
                BatchKey.wind_id: xr_data["pv_system_id"].values.astype(np.float32),
                BatchKey.wind_observed_capacity_wp: (xr_data["observed_capacity_wp"].values),
                BatchKey.wind_nominal_capacity_wp: (xr_data["nominal_capacity_wp"].values),
