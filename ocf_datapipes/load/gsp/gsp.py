...
class OpenGSPIterDataPipe(IterDataPipe):
    ...
    def __iter__(self) -> xr.DataArray:
        ...
        data_array = put_gsp_data_into_an_xr_dataarray(
            ...
            installedcapacity_mwp=gsp_pv_power_mw_ds.installedcapacity_mwp.data.astype(np.float32),
            capacity_mwp=gsp_pv_power_mw_ds.capacity_mwp.data.astype(np.float32),
        )
