...
def nwp_pv_datapipe(
    ...
    pv_datapipe, pv_location_datapipe = OpenPVFromNetCDF(pv=configuration.input_data.pv).\
        fork(
    ...
    nwp_datapipe = nwp_datapipe.add_t0_idx_and_sample_period_duration(
        sample_period_duration=timedelta(minutes=configuration.input_data.nwp.time_resolution_minutes),
