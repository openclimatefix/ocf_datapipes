...
from ocf_datapipes.load import load_configuration, OpenNWP, OpenPVFromNetCDF
...
def pv_nwp_datapipe(
    ...
    pv_datapipe, pv_time_periods_datapipe, pv_valid_times_datapipe, pv_location_datapipe = (
    ...
    # Slice PV systems
    pv_datapipe = pv_datapipe.select_id(
    ...
    pv_valid_times_datapipe = (
        pv_valid_times_datapipe.select_time_periods(time_periods=overlapping_datapipe)
    )
