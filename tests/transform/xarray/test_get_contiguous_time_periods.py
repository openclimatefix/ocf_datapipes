...
def test_get_contiguous_time_periods():
    ...
    expected_results = [
        pd.DataFrame(
            {
                "start_dt":pd.to_datetime(
                 ['2023-01-01 03:00:00', '2023-01-02 03:00:00'] 
                ),
                "end_dt":pd.to_datetime(
                 ['2023-01-01 21:00:00', '2023-01-03 06:00:00'] 
                ),
            }, 
        ),
        pd.DataFrame(
            {
                "start_dt":pd.to_datetime(
                 ['2023-01-01 05:00:00', '2023-01-02 05:00:00', '2023-01-02 14:00:00',] 
                ),
                "end_dt":pd.to_datetime(
                 ['2023-01-01 21:00:00', '2023-01-02 12:00:00', '2023-01-03 06:00:00',] 
                ),
            }, 
        ),
        pd.DataFrame(
            {
                "start_dt":pd.to_datetime(
                 ['2023-01-01 05:00:00', '2023-01-01 11:00:00', '2023-01-02 05:00:00',
                 '2023-01-02 14:00:00'] 
                ),
                "end_dt":pd.to_datetime(
                 ['2023-01-01 09:00:00', '2023-01-01 18:00:00', '2023-01-02 09:00:00',
                 '2023-01-03 03:00:00'] 
                ),
            }, 
        ),
        pd.DataFrame(
            {
                "start_dt":pd.to_datetime(
                 ['2023-01-01 05:00:00', '2023-01-01 11:00:00', '2023-01-01 14:00:00',
                 '2023-01-02 05:00:00', '2023-01-02 14:00:00', '2023-01-02 17:00:00',
                 '2023-01-02 20:00:00', '2023-01-02 23:00:00',] 
                ),
                "end_dt":pd.to_datetime(
                 ['2023-01-01 06:00:00', '2023-01-01 12:00:00', '2023-01-01 15:00:00',
                 '2023-01-02 06:00:00', '2023-01-02 15:00:00', '2023-01-02 18:00:00',
                 '2023-01-02 21:00:00', '2023-01-03 00:00:00',] 
                ),
            }, 
        ),
    ]
