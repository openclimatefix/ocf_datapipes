...
def test_get_metadata_from_pvsites_database():
    ...
    for column in [
        "orientation", "tilt", "longitude",
        "latitude", "capacity_kw", "ml_id",
    ]:
...
def test_open_pv_from_pvsites_db():
    ...
    for variable in [
        "time_utc", "pv_system_id", "observed_capacity_watt_power", "metadata_capacity_watt_power", 
        "orientation", "tilt", "longitude", "latitude", "ml_id",
    ]:
