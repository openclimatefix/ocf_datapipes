...
def test_combine_to_single_dataset_same_init_time(xarray_dict_sample):
    ...
    xarray_dict_sample["nwp"] = xarray_dict_sample["nwp"].assign_coords({"init_time_utc": ("target_time_utc",init_time_utcs)})
    ...
    xarray_dict_sample["nwp"] = xarray_dict_sample["nwp"].transpose("target_time_utc","channel","latitude","longitude")
