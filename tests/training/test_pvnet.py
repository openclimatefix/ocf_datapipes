...
from ocf_datapipes.training.pvnet import construct_loctime_pipelines, construct_sliced_data_pipeline, pvnet_datapipe
...
def test_construct_sliced_data_pipeline(configuration_filename):
    ...
    loc_pipe = IterableWrapper([
        Location(x=246699.328125, y=849771.9375, id=18)
    ])
